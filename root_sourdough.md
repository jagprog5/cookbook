...
Place 1 medium-large sized purple japanese sweet yam on parchment paper on a
baking sheet. Or, substitute with any vegetable which can be baked then easily
mashed. It should be moist. For example:

- any sweet potato or yam
- squash (buttercup, butternut, ...)
- absolutely *DO NOT* use normal potatoes

Bake the yam at 400F for 1hr. After baking, the skin can be pulled off and
discarded. Let it cool to near room temperature before mixing with other
ingredients. Otherwise the heat will kill the starter. But not too cold (e.g.
fridge) or else it will be more difficult to mix later on.
